...
NMEA_TALKERS = {
    ...
    "ZV": "Radio Update",
    # ***************************************************************
    # Custom from Maritime Robotics:
    # ***************************************************************
    "PMAR": "Otter USV from Maritime Robotics",
}
...
NMEA_MSGIDS_PROP = {
    ...
    "FOO": "Dummy message",
    # ***************************************************************
    # Maritime Robotics custom messages
    # ***************************************************************
    "MARGPS": "Maritime Robotics on board GPS",
    "MARIMU": "Maritime Robotics on board IMU",
    "MAROTR": "Maritime Robotics motor status",
    "MARMOD": "Maritime Robotics mode and fuel capacity",
    "MARERR": "Maritime Robotics error message",
    "MARABT": "Abort message to automatically put the USV into drift mode",
    "MARMAN": "Put USV into manual control mode",
    "MARCRS": "Put USV into course mode",
    "MARLEG": "Put USV into leg mode (foloe a leg between 2 points with a given speed",
    "MARSTA": "Put USV into station mode",
    "MARPRM": "Set parameters used for different modes",
}
